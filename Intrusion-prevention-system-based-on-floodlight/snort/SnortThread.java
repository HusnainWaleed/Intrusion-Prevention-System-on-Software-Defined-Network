...
public class SnortThread extends Thread {
	...
	protected static int count=1;// Record several snorts connected
...
class ServerThread extends Thread{
	...
	public void run() {
		...
		try {
			...
			String info = null;
			// Read the warning message and parse it into firewall rules, then add
