...
# Note that the path for unixsocket communication specified by snort is the same
SOCKFILE = "/tmp/temp1/snort_alert"
BUFSIZE = 65863
# Controller IP
CONTROLLER_IP = '127.0.0.1'
# The port and URL of the controller RESTful API access
CONTROLLER_PORT="8080"
CONTROLLER_URL="http://"+CONTROLLER_IP+":"+CONTROLLER_PORT+"/wm/snort/alerts/json"
# Controller socket communication port
...
class SnortListener():
    ...
    def packet_print(self, pkt,alert):
        ...
        tcp = pkt.get_protocol(ipv4.tcp.tcp)
    ...
    def tcp_send(self, data):
        ...
        self.send_json(s2)# Send alerts with RESTful API
    #self.nwsock.sendall(json.dumps(s2)+'\n') # Send warnings with socket
